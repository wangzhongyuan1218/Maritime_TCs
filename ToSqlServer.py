...
import numpy as np
TABLE_NAME='Dynamic_2017'
TEMP_PATH=r"D:\AIS_TEMP\1"
...
def read_dataframe(file):
    ...
    while(True):
        try:
            if is_exist("pandas_logs.csv",file) and is_exist('Database_logs.csv',os.path.join(TEMP_PATH,temp_name)):
                return
            else:
                break
        except:
